    ...
    for (var b = [], c = /&/g, d = /</g, e = />/g, f = /\n/g, g = 0; g < a.length; g++) {
        ...
        switch (h) {
            ...
            case DIFF_DELETE:
                ...
                if (/\s/.test(l)) {
                    var stringsize = l.length;
                    var missignString = "";
                    for (i = 1; i < stringsize; i++) {
                        missignString = missignString + "*";
                    }
                    b[g] = '<ins class="diffins">' + missignString + "</ins> ";
                } else {
                    var stringsize = l.length;
                    var missignString = "";
                    for (i = 1; i < stringsize; i++) {
                    ...
                    b[g] = '<del class="diffdel">' + missignString + "</del>";
                }
                break;
            case DIFF_EQUAL:
                b[g] = "<span class=\"diffspan\">" + l + "</span>";
        }
    }
    return b.join("");
};
